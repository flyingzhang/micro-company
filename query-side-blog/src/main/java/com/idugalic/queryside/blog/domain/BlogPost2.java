...
public class BlogPost2 {
    ...
    public BlogPost2(String id, Long aggregateVersion, String title, String rawContent, String renderContent, String publicSlug, Boolean draft,
    ...
    public BlogPost2(BlogPostCreatedEvent event, Long aggregateVersion) {
        super();
        this.id = event.getId();
        this.aggregateVersion = aggregateVersion;
